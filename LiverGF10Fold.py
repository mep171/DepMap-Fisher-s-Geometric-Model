...
NORM_FLOOR = 1e-3
DATA_FILE_PATH = "OnlyCancerGenesFixed/LiverOnlyCancerGenesFixed.csv"
...
def main():
    ...
    if results_list:
        ...
        cv_df.to_csv("Liver_CV10_D2_Results.csv", index=False)
        ...
        print("Results saved to 'Liver_CV10_D2_Results.csv'.")
